...
Function SLP_IXPS_init()
	...
	SetDimLabel 1,40,CorrAdj_x2,SLP_IXPS_ScanListW//Not used anymore
	SetDimLabel 1,41,CorrAdj_y2,SLP_IXPS_ScanListW//Not used anymore
	SetDimLabel 1,42,CorrAdj_mag2,SLP_IXPS_ScanListW//Not used anymore
	SetDimLabel 1,43,CorrAdj_Size2,SLP_IXPS_ScanListW//Not used anymore
	SetDimLabel 1,44,CorrAdj_Rot2,SLP_IXPS_ScanListW//Not used anymore
...
Function SLP_IXPS_CreatePanel1() : Panel
	...
	Button Button_ChooseScrnMsk,pos={Ctrl_xPos0,250},size={190,16},title="Copy screen mask from..",fSize=10,proc=ButtonProc_IXPS_CopyScrn

	PopupMenu Popup_FitType,pos={16,275},size={230,16},bodyWidth=180,title="Fit mode:",proc=PopMenuProc_FitSel
	PopupMenu Popup_FitType,mode=1,value= #"\"Secondary yield cut-off;1GLA;2GLAs;3GLAs;4GLAs\"",fsize=12
	...
	Button Button_AutoCorr,pos={486,464},size={120,16},proc=ButtonProc_IXPS_AutoCorr,title="Auto create correction"
...
Function SLP_IXPS_GenIsoChrom(VolName)
	...
	variable a1,b1,C,a2,b2
	
	a1=twoDParabolic_CoefW[0]
	b1=twoDParabolic_CoefW[1]
	C=twoDParabolic_CoefW[2]
	a2=twoDParabolic_CoefW[3]
	b2=twoDParabolic_CoefW[4]
	
	killwaves twoDParabolic_CoefW
	
	Corr1=a1*x^2+b1*x+C+a2*y^2+b2*y
...
Function SLP_IXPS_Extract1GLA(VolName,LLim,ULim)
	...
	If (V_Value==0)
		FuncFit /Q/W=2/NTHR=0/TBOX=768  {{SLP_StrightLine,BG_Coef,HOLD=HoldStr_BG},{SLP_InvGLA_FitFunc,GLA1_coef,HOLD=HoldStr_GLA1}}  ZProfW  /D /M=ZProfMskW /C=$FitCoefConstraintsW_FName 
	Elseif (V_Value==1) //Fast mode
		FuncFit /N=1/Q/W=2/NTHR=0/TBOX=768  {{SLP_StrightLine,BG_Coef,HOLD=HoldStr_BG},{SLP_InvGLA_FitFunc,GLA1_coef,HOLD=HoldStr_GLA1}}  ZProfW  /D /M=ZProfMskW /C=$FitCoefConstraintsW_FName
...
Function SLP_IXPS_Extract2GLAs(VolName,LLim,ULim)
	...
	If (V_Value==0)
		FuncFit /Q/W=2/NTHR=0/TBOX=768 {{SLP_StrightLine,BG_Coef,HOLD=HoldStr_BG},{SLP_InvGLA_FitFunc,GLA1_coef,HOLD=HoldStr_GLA1},{SLP_InvGLA_FitFunc,GLA2_coef,HOLD=HoldStr_GLA2}}  ZProfW  /D /M=ZProfMskW /C=$FitCoefConstraintsW_FName
	Elseif (V_Value==1) //Fast mode
		FuncFit /N=1/Q/W=2/NTHR=0/TBOX=768 {{SLP_StrightLine,BG_Coef,HOLD=HoldStr_BG},{SLP_InvGLA_FitFunc,GLA1_coef,HOLD=HoldStr_GLA1},{SLP_InvGLA_FitFunc,GLA2_coef,HOLD=HoldStr_GLA2}}  ZProfW  /D /M=ZProfMskW /C=$FitCoefConstraintsW_FName
		// /N=1 = fast mode (no display for fit steps)
		DoUpdate
	Endif
...
Function SLP_IXPS_Extract3GLAs(VolName,LLim,ULim)
	...
	If (V_Value==0)
		FuncFit /Q/W=2/NTHR=0/TBOX=768 {{SLP_StrightLine,BG_Coef,HOLD=HoldStr_BG},{SLP_InvGLA_FitFunc,GLA1_coef,HOLD=HoldStr_GLA1},{SLP_InvGLA_FitFunc,GLA2_coef,HOLD=HoldStr_GLA2},{SLP_InvGLA_FitFunc,GLA3_coef,HOLD=HoldStr_GLA3}}  ZProfW  /D /M=ZProfMskW /C=$FitCoefConstraintsW_FName
	Elseif (V_Value==1) //Fast mode
		FuncFit /N=1/Q/W=2/NTHR=0/TBOX=768 {{SLP_StrightLine,BG_Coef,HOLD=HoldStr_BG},{SLP_InvGLA_FitFunc,GLA1_coef,HOLD=HoldStr_GLA1},{SLP_InvGLA_FitFunc,GLA2_coef,HOLD=HoldStr_GLA2},{SLP_InvGLA_FitFunc,GLA3_coef,HOLD=HoldStr_GLA3}}  ZProfW  /D /M=ZProfMskW /C=$FitCoefConstraintsW_FName
		// /N=1 = fast mode (no display for fit steps)
		DoUpdate
	Endif
...
Function SLP_IXPS_Extract4GLAs(VolName,LLim,ULim)
	...
	If (V_Value==0)
		FuncFit /Q/W=2/NTHR=0/TBOX=768 {{SLP_StrightLine,BG_Coef,HOLD=HoldStr_BG},{SLP_InvGLA_FitFunc,GLA1_coef,HOLD=HoldStr_GLA1},{SLP_InvGLA_FitFunc,GLA2_coef,HOLD=HoldStr_GLA2},{SLP_InvGLA_FitFunc,GLA3_coef,HOLD=HoldStr_GLA3},{SLP_InvGLA_FitFunc,GLA4_coef,HOLD=HoldStr_GLA4}}  ZProfW  /D /M=ZProfMskW /C=$FitCoefConstraintsW_FName
	Elseif (V_Value==1) //Fast mode
...
Function SLP_IXPS_CreateParamMap(VolName,bin,FittingName,LLim,ULim)
	...
	strswitch(FittingName)	// string switch
		...
		case "1GLA":
			N_Params=10
			//ExtCmd="SLP_IXPS_Extract1GLA(VolName,LLim,ULim)"
			break
		case "2GLAs":
			N_Params=16
			...
			If (ScrnMskW[i][j])
				...
				Strswitch(FittingName)	// string switch
					case "Secondary yield cut-off":
						...
						break
					case "1GLA":
						SLP_IXPS_Extract1GLA(VolName,LLim,ULim)
						break
					case "2GLAs":
						SLP_IXPS_Extract2GLAs(VolName,LLim,ULim)
						break
					case "3GLAs":
						SLP_IXPS_Extract3GLAs(VolName,LLim,ULim)
						break
					case "4GLAs":
						SLP_IXPS_Extract4GLAs(VolName,LLim,ULim)
						break
				EndSwitch
		...
		case 2: // mouse up
			...
			If (V_Flag!=-1) //User select a folder
				...
				If (!V_Flag1) //User click continue
					...
					//Auto set the Fit LLim and ULim from the range of the scan
					NVAR LLim=root:Package_SLP:ImgXPS:LLim
					NVAR ULim=root:Package_SLP:ImgXPS:ULim
