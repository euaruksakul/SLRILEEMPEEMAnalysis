...
Function SLP_MGFit_CreatePanel() : Panel
	...
	NewPanel /W=(100,40,1200,600) /N=SLP_MultiGLAFit_01
	...
	ListBox ListBox_PeakConstraints,widths={50,a,a,32}
	...
	ListBox ListBox_DataList,widths={32,50,100},SelRow=GDataRow
	...
	ListBox ListBox_Library,widths={32,50,100,a,a,a,a,a,a,a,a,a,a,a,a,a}
	...
	Button button_Done,pos={801,420},size={50,20},title="Done",proc=ButtonProc_MGFit_Done
	...
	Button Button_ImportFromLib,pos={382,420},size={130,20},title="Import selected peak",fSize=10,proc=ButtonProc_MGFit_ImportFromLib
	Button Button_EditLib,pos={517,420},size={70,20},proc=ButtonProc_MGFit_EditLib,title="Edit library..",fSize=10
	Button Button_AddLibItem,pos={381,442},size={100,20},proc=ButtonProc_MGFit_AddLibItem,title="Add to library..",fSize=10
	Button Button_RemoveLibItem,pos={486,442},size={120,20},proc=ButtonProc_MGFit_RemoveFromLib,title="Remove selected peak",fSize=10
	Button Button_SaveLib,pos={380,464},size={100,20},proc=ButtonProc_MGFit_SaveLibAsTxt,title="Save library as..", fSize=10
	Button Button_LoadLib,pos={489,464},size={120,20},proc=ButtonProc_MGFit_LoadLibFile,title="Load library from file..",fSize=10
	Button Button_AddLibFromGss,pos={465,251},size={200,20},proc=ButtonProc_MGFit_AddLibItemGss,title="Add highlighted peak to library",fSize=10
  	Button button_Fit,pos={700,255},size={50,23},proc=ButtonProc_MGFit_Fit,title="FIT"
...
Function SLP_MGFit_Init()
	...
	SetDimLabel 1,2,OrgDataFolder,SLP_MGFit_DataListW
	...
	//SetDimLabel 1,18,yyy,SLP_MGFit_DataListW
	...
	switch( ba.eventCode )
		case 2: // mouse up
			...
			If (!DataFolderExists(NewFolderName))
				...
				run_flg=1
			Else
				DoAlert 1,DataName+" folder already exists. Overwrite existing waves?"
				If (V_Flag==1) //Click yes
					run_flg=1
				Else //Click no
					DoAlert 1,"Enter new folder name?"
					If (V_Flag==1)
...
Function SLP_MGFit_AddDataW(DataW_FName)
	...
	SLP_MGFit_DataListW[N_Data][2]=DataFolder_Name
...
//	CoefGuessM[][4]=Init_as
	...
	ConstraintW[3][1][]=0.001 //max mix=0.999
	ConstraintW[4][0][]=0.001 //min as=0.001
	ConstraintW[4][1][]=0.001 //min as=0.999
...
Function SLP_MGFit_DisplaySelectedData(DataName)
	...
	//Modifygraph /W=SLP_MultiGLAFit_01#G0 rgb=(65535,0,0),mirror=1,minor=1,tick=2
	DoUpdate
...
Function ButtonProc_MGFit_Fit(ba) : ButtonControl
	...
	switch( ba.eventCode )
		case 2: // mouse up
			...
			//DISPLAY RESULTS
			SLP_MGFit_DataListW[DataRow][17]="1"
			SLP_MGFit_DisplaySelectedData(DataName)
...
//			
//			SLP_Util_RemoveAllTraces("SLP_MultiGLAFit_01#G0")
//			Appendtograph /W=SLP_MultiGLAFit_01#G0 Data_nBGW
//			TraceName=StringFromlist(0,TraceNameList("SLP_MultiGLAFit_01#G0",";",1))
//			Modifygraph /W=SLP_MultiGLAFit_01#G0 mode($TraceName)=3, Marker($TraceName)=16, rgb($TraceName)=(43690,43690,43690)
//			Modifygraph /W=SLP_MultiGLAFit_01#G0 mirror=1,minor=1,tick=2
//
//			Appendtograph /W=SLP_MultiGLAFit_01#G0 FitW
//			TraceName=StringFromlist(1,TraceNameList("SLP_MultiGLAFit_01#G0",";",1))
//			Modifygraph /W=SLP_MultiGLAFit_01#G0 rgb($TraceName)=(0,40000,0),LSize($TraceName)=3
//			
//			For (i=0;i<dimsize(CoefGuessDispW,0);i+=1)
//				If (CoefGuessDispSelW[i][0]==48)
//					sprintf Index_str,"%02d",j
//					CoefW_FName=Data_nBGW_FName+"_c"+Index_str
//					ComponentW_FName=Data_nBGW_FName+"_f"+index_str
//					
...
//					
//					Appendtograph /W=SLP_MultiGLAFit_01#G0 ComponentW
//					//TraceName=StringFromlist(1+j,TraceNameList("SLP_MultiGLAFit_01#G0",";",1))
//					//Modifygraph /W=SLP_MultiGLAFit_01#G0 rgb($TraceName)=(65535,0,0)
//					j+=1
//				EndIf
//			EndFor
