...
Function SLP_IXPS_CreatePanel1() : Panel
	...
	PopupMenu Popup_FitType,mode=1,value= #"\"Secondary yield cut-off;1GLA;2GLAs\"",fsize=12
...
Function SLP_IXPS_Extract1GLA(VolName,LLim,ULim)
	...
	If (V_Value==0)
		FuncFit /Q/W=2/NTHR=0/TBOX=768  {{SLP_StrightLine,BG_Coef,HOLD=HoldStr_BG},{SLP_GLA_FitFunc,GLA1_coef,HOLD=HoldStr_GLA1}}  ZProfW  /D /M=ZProfMskW /C=$FitCoefConstraintsW_FName 
	Elseif (V_Value==1) //Fast mode
		FuncFit /N=1/Q/W=2/NTHR=0/TBOX=768  {{SLP_StrightLine,BG_Coef,HOLD=HoldStr_BG},{SLP_GLA_FitFunc,GLA1_coef,HOLD=HoldStr_GLA1}}  ZProfW  /D /M=ZProfMskW /C=$FitCoefConstraintsW_FName
...
Function SLP_IXPS_Extract2GLAs(VolName,LLim,ULim)
	...
	If (V_Value==0)
		FuncFit /Q/W=2/NTHR=0/TBOX=768 {{SLP_StrightLine,BG_Coef,HOLD=HoldStr_BG},{SLP_GLA_FitFunc,GLA1_coef,HOLD=HoldStr_GLA1},{SLP_GLA_FitFunc,GLA2_coef,HOLD=HoldStr_GLA2}}  ZProfW  /D /M=ZProfMskW /C=$FitCoefConstraintsW_FName
	Elseif (V_Value==1) //Fast mode
		FuncFit /N=1/Q/W=2/NTHR=0/TBOX=768 {{SLP_StrightLine,BG_Coef,HOLD=HoldStr_BG},{SLP_GLA_FitFunc,GLA1_coef,HOLD=HoldStr_GLA1},{SLP_GLA_FitFunc,GLA2_coef,HOLD=HoldStr_GLA2}}  ZProfW  /D /M=ZProfMskW /C=$FitCoefConstraintsW_FName
		// /N=1 = fast mode (no display for fit steps)
		DoUpdate
	Endif
...
Function SLP_IXPS_MakeGuessCurve(VolName,FitName)
	...
	strswitch(FitName)	// string switch
		...
		Case "1GLA":			
			...
			FitZProfW=Line_Offset+x*Line_Slope+SLP_GLA_Func(p1_int,p1_pos,p1_fwhm,p1_mix,p1_as,x)
			Break	
		Case "2GLAs":			
			 Line_Offset=str2num(FitCoefDisplayW[0][4])
			 Line_Slope=str2num(FitCoefDisplayW[1][4])
